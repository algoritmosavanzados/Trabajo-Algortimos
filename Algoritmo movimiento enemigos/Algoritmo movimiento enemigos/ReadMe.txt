========================================================================
    APLICACIÓN: Información general del proyecto Algoritmo movimiento enemigos
========================================================================

AppWizard ha creado esta aplicación Algoritmo movimiento enemigos.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación Algoritmo movimiento enemigos.

Algoritmo movimiento enemigos.vcproj
...
Algoritmo movimiento enemigos.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Algoritmo movimiento enemigos.pch y un archivo de 
